// Generated by scripts/vendor-datasets.ts on 2026-09-22
// Source: https://gist.githubusercontent.com/eugene-shvarts/900632789a24983d5678ffd508dd01f6/raw/cf9c2ab422d568deade949ef0a06bed6896964b9/github-tos.txt
// License: CC0 1.0 (github/site-policy)
// Do not edit by hand; re-run `npm run vendor`.

export const GITHUB_TOS_LINES: readonly string[] = [
  "Effective date: April 27, 2026 · A. Definitions",
  ...
  "For the avoidance of doubt, use of Your Content to develop, train, and improve artificial intelligence and machine learning models and technologies of GitHub and our Affiliates is within the scope of this license and does not constitute a sale or other restricted transfer of Your Content.",
  ...
  "You further agree not to impose technical or other targeted measures to restrict or retaliate against such Access.",
  ...
  "J. AI Features, Training, and Your Data · 1. Applicability",
  ...
  "2. Ownership · GitHub does not claim ownership of your Input or Output.",
  ...
  "If you opt out, GitHub will not collect or use your Inputs and Outputs for the purposes described in this paragraph from the effective date of your opt-out going forward.",
  ...
  "3. Feedback",
  "We’re always trying to improve our products and services, and your feedback as a Beta Preview user will help us do that.",
  ...
  "For any other modifications, your continued use of the Website constitutes agreement to our revisions of these Terms of Service. You can view all changes to these Terms in our Site Policy repository.",
  "We reserve the right at any time and from time to time to modify or discontinue, temporarily or permanently, the Website (or any part of it) with or without notice.",
  "S. Miscellaneous · 1. Governing Law",
  "Except to the extent applicable law provides otherwise, this Agreement between you and GitHub and any access to or use of the Website or the Service are governed by the federal laws of the United States of America and the laws of the State of California, without regard to conflict of law provisions. You and GitHub agree to submit to the exclusive jurisdiction and venue of the courts located in the City and County of San Francisco, California. However, any claim for injunctive relief with respect to a violation of section D.",
  "9 may be brought in any jurisdiction.",
  "2. Non-Assignability",
  ...
  "This Agreement may only be modified by a written amendment signed by an authorized representative of GitHub, or by the posting by GitHub of a revised version in accordance with Section R. Changes to These Terms. These Terms of Service, together with the GitHub Privacy Statement, represent the complete and exclusive statement of the agreement between you and us.",
  "This Agreement supersedes any proposal or prior agreement oral or written, and any other communications between you and GitHub relating to the subject matter of these terms including any confidentiality or nondisclosure agreements.",
  "6. Questions",
