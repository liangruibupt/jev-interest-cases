...
export const SCENARIOS: ScenarioMeta[] = [
  ...
  { id: "c1", path: "/c1", title: "C1 作业按细则评分", subtitle: "教育：细则 Noul + 情境 Score，低置信度交老师", proves: "行业判断：评分是文字判断，句数与算术留给代码", group: "industry", status: "planned" },
  { id: "c2", path: "/c2", title: "C2 患者留言分诊", subtitle: "医疗：紧急度 + 红旗 + 科室，数值由代码比较", proves: "行业判断：分诊可以，诊断不行", group: "industry", status: "planned" },
